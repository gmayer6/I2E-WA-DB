...
\Emph{The Normal Distribution} \\
Use polar coordinates and the result from the previous question to show that 
\begin{align*}
   \int_{0}^{\infty} e^{-x^2} dx
   = \frac{\sqrt{\pi}}{2}.
\end{align*}
This result is important in probability and statistics: the above integral is related to the \Emph{normal} or \Emph{Gaussian distribution}. 
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\item % INTEGRATION IN A SPHERE
\Emph{Integration Inside a Sphere} \\
