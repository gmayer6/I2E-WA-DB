...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\item
Complete Exercises 1c and 2 from Section 8.1.1 of \CAT. Exercise 1c is the following:
\begin{quote}
Put the following system of linear equations into triangular form and then solve the system if possible. Classify the system as consistent independent, consistent dependent, or inconsistent. 
\begin{align*}
4x-y+z &= 5 \\
2y+6z &= 30\\
x+z &=5 
...
\begin{quote}
Find two other forms of the parametric solution to Exercise 1c above by reorganizing the equations so that $x$ or $y$ can be the free variable.
\end{quote}
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\item
Complete exercise 6 from Section 8.1.1 of \CAT. 
\begin{quote}
Discuss with your classmates why it is impossible to mix a 20\% acid solution with a 40\% acid solution to produce a 60\% acid solution. If you were to try to make 100 mL of a 60\% acid solution using stock solutions at 20\% and 40\%, respectively, what would the triangular form of the resulting system look like?
\end{quote}
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
